...
#define BATTLE_CIRCUS_TRADE_MON				0x80000
#define BATTLE_CIRCUS_SAFEGUARD				0x100000 //Side Effects
...
#define FIRST_BATTLE_CIRCUS_SIDE_EFFECT_FLAG BATTLE_CIRCUS_SAFEGUARD
