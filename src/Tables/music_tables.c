...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_HIKER] = BGM_RSE_FATTY_ENCOUNTER,
	...
	[CLASS_TEAM_ROCKET] = BGM_DD_KURU_RUINS_TRAP_ROOM,
	...
	[CLASS_RUIN_MANIAC] = BGM_RSE_FATTY_ENCOUNTER,
...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_AQUA_LEADER] = BGM_DD_ART_MUSEUM,
	[CLASS_TEAM_ROCKET] = BGM_DD_SKULLKER_DRILL_MISSILE,
	[CLASS_RIVAL] = BGM_DD_CARRIE_PLEA,
};
